...
if _G.WeroShinyXIsAlreadyRunning then
...
_G.WeroShinyXIsAlreadyRunning = true

local Window = Fluent:CreateWindow({
    Title = "WeroShiny Hub - Evade Overhaul",
    SubTitle = "v2 Made By IDK AND IDC",
    TabWidth = 160,
...
if not require then
    return LocalPlayer:Kick("unc missing: require(path) | pls try another executor support require(path)")
else
   print("Supported require()")
end

if not firetouchinterest  then
    return LocalPlayer:Kick("unc missing: firetouchinterest() | pls try another executor support firetouchinterest()")
else
   print("Supported firetouchinterest()")
end

if not setfpscap or setfpscap(500) then
    return LocalPlayer:Kick("unc missing: setfpscap() | pls try another executor support setfpscap()")
else
...
do
    ...
    local function StartUI()
        ...
        local sg, frame = CreateBaseWindow(UDim2.new(0, 260, 0, 200), "WeroShiny Teleports")
...
Tabs.Info:AddParagraph({
        Title = "WeroShiny Hub X / Overhaul Script",
        Content = "Created by IDK AND IDC"
    })
...
Tabs.Info:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/PAW6eSAQa")
    end
})
...
task.spawn(function()
    ...
    local skyData = {
        ...
        ["WeroShiny"] = "rbxassetid://75138310179914",
...
-- Save Folder
InterfaceManager:SetFolder("WeroShinyXUniversal")
FBM:SetFolder("WeroShinyXUniversal/Evade/FloatingButtons")
SaveManager:SetFolder("WeroShinyXUniversal/Evade")
