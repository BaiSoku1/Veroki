...
MainTab:AddToggle("FlyToggle", {Title = "Fly",Description = "Enable fly mode (Use WASD/Joystik to move, Space=Up, Shift=Down)",Default = false,Callback = function(state) if state then startFlying() else stopFlying() end end})
...
print("Veroki Hub loaded successfully with Fluent UI and DraconicBtn :] !")